            ...
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center space-x-8">
                    ...
                    <div class="hidden md:flex space-x-8">
                        ...
                        <a href="<?php echo e(route('shop.index')); ?>" class="text-gray-400 hover:text-[#22c55e] transition-colors">Shop</a>
                ...
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('cart.index')); ?>" class="relative p-2 text-gray-400 hover:text-[#22c55e] transition-colors">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                        <span id="cart-count" class="absolute -top-1 -right-1 bg-[#22c55e] text-white text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center <?php echo e(count(session('cart', [])) > 0 ? '' : 'hidden'); ?>">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 mt-2 w-48 bg-[#1f2937] rounded-lg shadow-lg border border-[#374151] py-2 z-50">
                                <a href="<?php echo e(route('user.dashboard')); ?>" class="block px-4 py-2 text-gray-400 hover:text-[#22c55e] transition-colors">Dashboard</a>
                                <a href="<?php echo e(route('orders.index')); ?>" class="block px-4 py-2 text-gray-400 hover:text-[#22c55e] transition-colors">My Orders</a>
                                <a href="<?php echo e(route('user.profile')); ?>" class="block px-4 py-2 text-gray-400 hover:text-[#22c55e] transition-colors">Profile</a>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-gray-400 hover:text-[#22c55e] transition-colors">Login</a>
                        <a href="<?php echo e(route('register')); ?>" class="px-4 py-2 bg-[#22c55e] hover:bg-[#16a34a] text-white font-medium rounded-lg transition-all">Register</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <main>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="text-center max-w-4xl mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-4">
                        <a href="<?php echo e(route('shop.index')); ?>" class="px-8 py-4 bg-[#22c55e] hover:bg-[#16a34a] text-white font-semibold rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg shadow-[#22c55e]/25">
                            Shop Now
                        </a>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <?php $__empty_1 = true; $__currentLoopData = \App\Models\Product::with('images')->active()->featured()->inStock()->limit(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="group bg-[#111827] rounded-xl overflow-hidden border border-[#374151] hover:border-[#22c55e]/50 transition-all duration-300 hover:shadow-xl hover:shadow-[#22c55e]/10">
                                <a href="<?php echo e(route('shop.show', $product->slug)); ?>" class="block">
                                    <div class="aspect-square overflow-hidden bg-[#1f2937]">
                                        <?php if($product->images->isNotEmpty()): ?>
                                            <img src="<?php echo e($product->images->first()->url); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                                        <?php else: ?>
                                ...
                                <div class="p-4">
                                    <a href="<?php echo e(route('shop.show', $product->slug)); ?>">
                                        ...
                                        <h3 class="font-semibold text-white mb-2 line-clamp-2 group-hover:text-[#22c55e] transition-colors"><?php echo e($product->name); ?></h3>
                                        <div class="flex items-center justify-between">
                                            <span class="text-lg font-bold text-[#22c55e]">$<?php echo e(number_format($product->price, 2)); ?></span>
                                            <?php if($product->compare_price): ?>
                                                <span class="text-sm text-gray-500 line-through">$<?php echo e(number_format($product->compare_price, 2)); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </a>
                                    <div class="mt-3 flex items-center gap-2">
                                        <button onclick="quickAddToCart(<?php echo e($product->id); ?>, event)" <?php echo e($product->quantity <= 0 ? 'disabled' : ''); ?> class="flex-1 py-2 px-3 bg-[#22c55e] hover:bg-[#16a34a] disabled:bg-gray-700 disabled:cursor-not-allowed text-white text-sm font-medium rounded-lg transition-colors">
                                            <?php echo e($product->quantity > 0 ? 'Add to Cart' : 'Out of Stock'); ?>

                                        </button>
                                        <button onclick="quickToggleWishlist(<?php echo e($product->id); ?>, event)" class="p-2 border-2 border-gray-600 text-gray-400 hover:border-red-500 hover:text-red-500 rounded-lg transition-colors">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <div class="col-span-4 text-center py-12 text-gray-500">
                                ...
                                <a href="<?php echo e(route('shop.index')); ?>" class="text-[#22c55e] hover:underline mt-2 inline-block">Browse all products</a>
                            </div>
                        <?php endif; ?>
                    </div>
            </div>
        ...
        <section id="categories" class="py-20 bg-[#111827]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                    <?php $__empty_1 = true; $__currentLoopData = \App\Models\Category::where('is_active', true)->root()->withCount('products')->limit(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e(route('shop.index', ['category' => $category->slug])); ?>" class="group bg-[#1f2937] rounded-xl p-8 border border-[#374151] hover:border-[#22c55e] transition-all duration-300 text-center hover:shadow-xl hover:shadow-[#22c55e]/10">
                            ...
                            <h3 class="font-semibold text-white mb-1"><?php echo e($category->name); ?></h3>
        ...
        <section class="py-20 bg-gradient-to-r from-[#22c55e] to-[#16a34a]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <a href="<?php echo e(route('shop.index')); ?>" class="inline-block px-8 py-4 bg-white text-[#22c55e] font-semibold rounded-lg hover:bg-gray-100 transition-all duration-200 transform hover:scale-105">
                    Explore the Shop
                </a>
            </div>
        </section>
    ...
    <footer class="bg-[#1f2937] border-t border-[#374151] py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        ...
                        <li><a href="<?php echo e(route('shop.index')); ?>" class="hover:text-[#22c55e] transition-colors">Shop</a></li>
            ...
            <div class="border-t border-[#374151] mt-8 pt-8 text-center text-sm text-gray-500">
                <p>&copy; <?php echo e(date('Y')); ?> FightWisdom. All rights reserved.</p>
            </div>
        </div>
    </footer>
    <script>
...
</html><?php /**PATH C:\Users\umesh\fightwisdoml\resources\views/welcome.blade.php ENDPATH**/ ?>