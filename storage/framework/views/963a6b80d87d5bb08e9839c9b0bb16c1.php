...
<?php $component->withAttributes(['title' => 'Dashboard']); ?>
    <div class="mb-8">
        ...
        <p class="text-gray-400 mt-1">Welcome back, <?php echo e(Auth::user()->name); ?></p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-[#1f2937] rounded-xl border border-[#374151] p-6 hover:border-[#22c55e]/50 transition-colors group">
            ...
            <p class="text-3xl font-bold text-white mt-1"><?php echo e($stats['totalOrders']); ?></p>
            <p class="text-gray-500 text-xs mt-2"><?php echo e($stats['pendingOrders']); ?> pending</p>
        </div>
        ...
        <div class="bg-[#1f2937] rounded-xl border border-[#374151] p-6 hover:border-[#22c55e]/50 transition-colors group">
            ...
            <p class="text-3xl font-bold text-[#22c55e] mt-1">$<?php echo e(number_format($stats['totalRevenue'], 2)); ?></p>
            <p class="text-gray-500 text-xs mt-2">This month: $<?php echo e(number_format($monthlyRevenue, 2)); ?></p>
        </div>
        ...
        <div class="bg-[#1f2937] rounded-xl border border-[#374151] p-6 hover:border-[#22c55e]/50 transition-colors group">
            ...
            <p class="text-3xl font-bold text-white mt-1"><?php echo e($stats['totalUsers']); ?></p>
            <p class="text-gray-500 text-xs mt-2"><?php echo e($monthlyOrders); ?> orders this month</p>
        </div>
        ...
        <div class="bg-[#1f2937] rounded-xl border border-[#374151] p-6 hover:border-[#22c55e]/50 transition-colors group">
            ...
            <p class="text-3xl font-bold text-white mt-1"><?php echo e($stats['totalProducts']); ?></p>
            <p class="text-yellow-400 text-xs mt-2"><?php echo e($stats['lowStockProducts']); ?> low stock</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2 bg-[#1f2937] rounded-xl border border-[#374151] overflow-hidden">
            <div class="p-6 border-b border-[#374151] flex justify-between items-center">
                ...
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-[#22c55e] hover:text-[#16a34a] text-sm font-medium">View All</a>
            </div>
                    ...
                    <tbody class="divide-y divide-[#374151]">
                        <?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-[#374151]/30 transition-colors">
                                ...
                                <td class="px-6 py-4 text-gray-300 text-sm"><?php echo e($order->user->name ?? 'N/A'); ?></td>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $topProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="p-4 flex items-center justify-between hover:bg-[#374151]/30 transition-colors">
                        <div class="flex-1 min-w-0">
                            <p class="text-white font-medium text-sm truncate"><?php echo e($product->product_name); ?></p>
                            <p class="text-gray-500 text-xs"><?php echo e($product->total_sold); ?> sold</p>
                        </div>
                        <p class="text-[#22c55e] font-semibold text-sm">$<?php echo e(number_format($product->total_revenue, 2)); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <?php if($stats['pendingReturns'] > 0): ?>
        <div class="mt-8 bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 flex items-center justify-between">
            <div class="flex items-center">
                ...
                <span class="text-yellow-400 font-medium"><?php echo e($stats['pendingReturns']); ?> pending return request(s)</span>
            </div>
            <a href="<?php echo e(route('admin.returns.index', ['status' => 'pending'])); ?>" class="text-yellow-400 hover:text-yellow-300 font-medium">Review Now</a>
        </div>
    <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\umesh\fightwisdoml\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>