...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.shop','data' => ['title' => 'Shopping Cart']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Shopping Cart']); ?>
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                        <div class="divide-y divide-gray-200">
                            <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="p-6 flex items-center gap-6" data-item-id="<?php echo e($item['product']->id); ?>">
                                    <a href="<?php echo e(route('shop.show', $item['product']->slug)); ?>" class="flex-shrink-0">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <a href="<?php echo e(route('shop.show', $item['product']->slug)); ?>" class="block">
                                            <h3 class="text-lg font-semibold text-gray-900 hover:text-[#22c55e] transition-colors line-clamp-1">
                                                <?php echo e($item['product']->name); ?>

                                            </h3>
                                        </a>
                                        <p class="text-sm text-gray-500 mt-1"><?php echo e($item['product']->category->name ?? 'Uncategorized'); ?></p>
                                        <p class="text-sm text-gray-500 mt-1">SKU: <?php echo e($item['product']->sku); ?></p>
                                        <div class="flex items-center mt-2">
                                            <?php if($item['product']->delivery_type === 'free'): ?>
                                            ...
                                            <?php else: ?>
                                                <span class="inline-flex items-center text-xs text-gray-600 bg-gray-100 px-2 py-1 rounded-full">
                                                    +$<?php echo e(number_format($item['delivery_charge'], 2)); ?> Delivery
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-6">
                                        <div class="flex items-center border border-gray-300 rounded-lg">
                                            <button type="button" 
                                                    onclick="window.updateQuantity(<?php echo e($item['product']->id); ?>, -1)"
                                            ...
                                            <input type="number" 
                                                   id="qty-<?php echo e($item['product']->id); ?>"
                                                   value="<?php echo e($item['quantity']); ?>" 
                                                   min="1" 
                                                   max="<?php echo e($item['product']->quantity); ?>"
                                                   onchange="window.setQuantity(<?php echo e($item['product']->id); ?>, this.value)"
                                            ...
                                            <button type="button" 
                                                    ...
                                                    <?php echo e($item['quantity'] >= $item['product']->quantity ? 'disabled' : ''); ?>>
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div class="text-right min-w-[100px]">
                                            <p class="text-lg font-bold text-[#22c55e]">$<?php echo e(number_format($item['item_total'], 2)); ?></p>
                                            <?php if($item['product']->compare_price): ?>
                                                <p class="text-sm text-gray-400 line-through">$<?php echo e(number_format($item['product']->compare_price * $item['quantity'], 2)); ?></p>
                                            <?php endif; ?>
                                        </div>

                                        <button type="button" onclick="window.removeItem(<?php echo e($item['product']->id); ?>)" 
                        ...
                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-between items-center">
                            <a href="<?php echo e(route('shop.index')); ?>" class="flex items-center text-gray-600 hover:text-[#22c55e] transition-colors">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                        ...
                        <div class="mt-6 space-y-4">
                            ...
                            <button type="button" onclick="window.location.href='<?php echo e(route('checkout.index')); ?>'" class="w-full py-4 px-6 bg-[#22c55e] hover:bg-[#16a34a] text-white font-semibold rounded-lg shadow-lg shadow-[#22c55e]/25 transition-all flex items-center justify-center gap-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<script>
    ...
    window.saveQuantity = function(productId, quantity) {
        ...
        fetch(`<?php echo e(url('/cart')); ?>/${productId}`, {
            method: 'PUT',
            headers: {
    ...
    window.clearCart = function(event) {
        ...
        .catch(error => {
            ...
            form.method = 'POST';
            form.action = '<?php echo e(route("cart.clear")); ?>';
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\umesh\fightwisdoml\resources\views/cart/index.blade.php ENDPATH**/ ?>