...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Orders']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
        ...
        <div class="p-6 border-b border-[#374151]">
            <form method="GET" class="flex flex-wrap gap-4">
                <div class="flex-1 min-w-[200px]">
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search order number..." class="w-full px-4 py-2.5 bg-[#111827] border border-[#374151] rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#22c55e] focus:border-transparent">
                </div>
                <div class="w-40">
                ...
                <div>
                    <input type="date" name="date_from" value="<?php echo e(request('date_from')); ?>" class="px-4 py-2.5 bg-[#111827] border border-[#374151] rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#22c55e] focus:border-transparent">
                </div>
                <div>
                    <input type="date" name="date_to" value="<?php echo e(request('date_to')); ?>" class="px-4 py-2.5 bg-[#111827] border border-[#374151] rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#22c55e] focus:border-transparent">
                </div>
        ...
        <div class="grid grid-cols-6 gap-4 p-4 bg-[#111827] border-b border-[#374151]">
            <?php $__currentLoopData = ['pending', 'confirmed', 'processing', 'shipped', 'delivered', 'cancelled']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="px-4 py-3 rounded-lg border <?php echo e($colors[$status]); ?>">
                    <p class="text-2xl font-bold"><?php echo e($counts); ?></p>
                ...
                <tbody class="divide-y divide-[#374151]">
                    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="hover:bg-[#374151]/30 transition-colors">
                            <td class="px-6 py-4">
                                <a href="<?php echo e(route('admin.orders.show', $order->order_number)); ?>" class="text-[#22c55e] hover:underline font-medium">
                                    <?php echo e($order->order_number); ?>

                                </a>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-white font-medium"><?php echo e($order->user->name ?? 'N/A'); ?></div>
                                <div class="text-gray-500 text-sm"><?php echo e($order->user->email ?? ''); ?></div>
                            </td>
                            <td class="px-6 py-4 text-gray-300">
                                <?php echo e($order->items->count()); ?> items
                            </td>
                            <td class="px-6 py-4">
                                <span class="text-[#22c55e] font-semibold">$<?php echo e(number_format($order->total, 2)); ?></span>
                            </td>
                            <td class="px-6 py-4">
                                <span class="px-3 py-1 text-xs font-medium rounded-full border <?php echo e($statusColors[$order->status] ?? 'bg-gray-500/20 text-gray-400 border-gray-500/30'); ?>">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end space-x-2">
                                    <a href="<?php echo e(route('admin.orders.show', $order->order_number)); ?>" class="p-2 text-gray-400 hover:text-[#22c55e] hover:bg-[#22c55e]/10 rounded-lg transition-all">
...
<?php endif; ?>
<?php /**PATH C:\Users\umesh\fightwisdoml\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>