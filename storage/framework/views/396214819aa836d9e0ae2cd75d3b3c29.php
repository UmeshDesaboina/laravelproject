...
<head>
    ...
    <title><?php echo e($title ?? 'Shop'); ?> - FightWisdom</title>
            ...
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:flex ml-10 space-x-8">
                        ...
                        <a href="<?php echo e(route('shop.index')); ?>" class="text-[#22c55e] px-3 py-2 font-medium">Shop</a>
                        <a href="#" class="text-gray-700 hover:text-[#22c55e] px-3 py-2 font-medium transition-colors">About</a>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('user.wishlist')); ?>" class="relative p-2 text-gray-600 hover:text-[#22c55e] transition-colors">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                        </svg>
                    </a>
                    <a href="<?php echo e(route('cart.index')); ?>" class="relative p-2 text-gray-600 hover:text-[#22c55e] transition-colors">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                                <a href="<?php echo e(route('user.dashboard')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors">
                                ...
                                <a href="<?php echo e(route('orders.index')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors">
                                    <div class="flex items-center gap-2">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('returns.index')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors">
                                    <div class="flex items-center gap-2">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('user.profile')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors">
                                    <div class="flex items-center gap-2">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-gray-600 hover:text-[#22c55e] transition-colors">Login</a>
                        <a href="<?php echo e(route('register')); ?>" class="text-gray-600 hover:text-[#22c55e] transition-colors">Register</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\umesh\fightwisdoml\resources\views/components/layouts/shop.blade.php ENDPATH**/ ?>